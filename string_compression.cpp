leetcode 443
    ...
    Input : chars = [ "a", "a", "b", "b", "c", "c", "c" ] Output : Return 6,
            and the first 6 characters of the input array should be : [ "a", "2", "b", "2", "c", "3" ] Explanation : The groups are "aa", "bb", and"ccc".This compresses to "a2b2c3".
...
public:
    int compress(vector<char> &chars)
    {
        ...
        while (i < n)
        {
            ...
            // yaha kb aayenge
            // ya toh vector poora traverse kr liya
            // ya fir nya character mila h'
